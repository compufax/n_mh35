...
if($_POST['ajax']==1) {
		//Listado de plazas
		$select= " SELECT *,CONCAT(c.numero,' ',c.nombre) as nomplaza FROM certificados a INNER JOIN plazas c ON c.cve = a.plaza WHERE CAST(a.certificado as UNSIGNED)='".intval($_POST['folio'])."' "; 
