...
if($_POST['ajax']==1){
	$filtro="";
	$select= " SELECT a.* FROM facturas as a WHERE a.plaza='".$_POST['plazausuario']."' AND a.fecha>='".$_POST['fecha_ini']."' AND a.fecha<='".$_POST['fecha_fin']."' ";
...
if($_POST['cmd']==6){
	...
	foreach($_POST['checksf'] as $cvefact){
		...
		if($row['estatus']=='C')
			$mail->AddAttachment("../cfdi/comprobantes/facturac_".$_POST['plazausuario']."_".$cvefact.".pdf", "Factura ".$cvefact.".pdf");
		else
