...
if($_POST['cmd']==50){
	...
	$select= " SELECT a.clabe,a.cuenta,a.nombre,a.plaza,a.nombre,a.puesto,a.rfc,a.imss,b.cve,b.totalpercepciones,b.totaldeducciones,a.salario_integrado as salario_base_personal, b.sal_diario,
	...
	$worksheet1->write_string(3,$c,'CLABE');$c++;
	...
	while($Personal=mysql_fetch_array($rspersonal)) {
		...
		$worksheet1->write_string($l,$c,$Personal['clabe']);$c++;
...
if($_POST['ajax']==1){
	...
	if(mysql_num_rows($rspersonal)>0) 
	{
		...
		echo '
		<th rowspan="2">Registro Patronal</th><th rowspan="2"><a href="#" onclick="SortTable(2,\'S\',\'tabla1\');">Nombre</a></th><th rowspan="2">Puesto</th><th rowspan="2">R.F.C.</th><th rowspan="2">N.S.S.</th><th rowspan="2">Cuenta</th><th rowspan="2">CLABE</th>';
		if($Periodo['aguinaldo']==1){
		...
		while($Personal=mysql_fetch_array($rspersonal)) {
			...
			echo '<td align="center">'.$Personal['clabe'].'</td>';
