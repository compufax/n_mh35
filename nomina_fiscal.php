...
if($_POST['ajax']==2){
	...
	$row=mysql_fetch_array($res);
	echo '<h1>'.$row['nompersonal'].'<br>'.$row['nomperiodo'].'<br>'.$row['fecha_ini'].' al '.$row['fecha_fin'].'</h1>';
...
if($_POST['cmd']==0){
	...
	echo '<div id="confirm" style="display:none"><h1>A quien desea enviar los archivos?</h1></div>';
	echo '<table>';
	echo '<tr>
