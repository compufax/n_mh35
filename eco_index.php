...
<body>
<p>&nbsp;</p>
<form id="forma" name="forma" method="POST" action="eco_inicio.php">
  <table width="530" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F1F3F5" class="loginTable">
    <tr>
      <td height="50" colspan="2" background="eco_images/bannertop-bg.gif">&nbsp;</td>
    </tr>
    <tr>
      <td width="50%"><div align="center">
        ...
        <table width="70%" border="0">
            <tr>
              <td><div align="center"><img src="eco_images/logingif.gif?<?php echo date("Y-m-d");?>" width="80" height="69" /></div></td>
            </tr>
            <tr>
              <td class="bodyText"><div align="center">&iexcl; ECOLOGIA ! </div></td>
            </tr>
            <tr>
      ...
      <td width="50%"><div align="center">
          ...
          <table width="90%" border="0" class="loginInnerTable">
            <tr>
              <td colspan="5"><img src="eco_images/login.gif" width="80" height="36" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
