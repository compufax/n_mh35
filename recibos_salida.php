...
if($_POST['ajax']==1) {
		//Listado de plazas
		$select= " SELECT * FROM recibos_salida WHERE plaza='".$_POST['plazausuario']."' AND fecha BETWEEN '".$_POST['fecha_ini']."' AND '".$_POST['fecha_fin']."'";
		...
		if(mysql_num_rows($res)>0) 
		{
			...
			while($row=mysql_fetch_array($res)) {
				...
				echo '<td align="left">'.htmlentities($array_beneficiarios[$row['beneficiario']]).'</td>';
