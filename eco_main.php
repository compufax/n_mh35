...
if(!$_SESSION['CallCveUsuario'] && !$_SESSION['CallNomUsuario'] && !isset($_POST['loginUser']) && !isset($_POST['loginPassword'])) {
...
if($_SESSION['CallCveUsuario']!=1 && $_POST['loginUser']!="root"){
	...
	if($Cerrado['cerrar_sistema']=='S'){
		echo '<script>window.location="eco_index.php";</script>';
	}
}
...
if (isset($_POST['loginUser']) && isset($_POST['loginPassword'])) {
	...
	$redirectLoginSuccess = "eco_inicio.php";
	$redirectLoginFailed = "eco_index.php?ErrLogUs=true";
	...
	$LoginRS_query = sprintf("SELECT * FROM eco_usuarios WHERE usuario = %s AND password = %s AND estatus!='I'",
	...
	if ($loginFoundUser) {
		...
		mysql_query("INSERT eco_registros_sistema SET usuario='".$Usuario['cve']."',entrada='".$fechahora."',ip='$ip'");
		...
		$_SESSION['CallCveUsuario'] = $Usuario['cve'];

		$_SESSION['CallNomUsuario'] = $Usuario['nombre'];

		$_SESSION['CallTipoUsuario'] = $Usuario['tipo'];

		$_SESSION['CallNickUsuario'] = $Usuario['usuario'];
				
		$_SESSION['Callreg_sistema'] = $reg_sistema;
...
if(intval($_POST['cveusuario'])==0){
	$_POST['cveusuario']=$_SESSION['CallCveUsuario'];
	$_POST['tipousuario']=$_SESSION['CallTipoUsuario'];
	$_POST['cveregistro']=$_SESSION['Callreg_sistema'];
}
...
function top($SESSION,$enter=0) {
	...
	$menuRS=mysql_query("SELECT * FROM eco_menu WHERE cve='".$_POST['cvemenu']."'");
	...
	<link rel="stylesheet" type="text/css" href="eco_css/style.css" />
	...
	<link rel="stylesheet" type="text/css" href="eco_css/ui.css" />
	...
	<script>
	if(top.window.location.href!="http://verificentros.net/ecologia/" && top.window.location.href!="http://vereficentros.hgaribay.com/ecologia/")
		top.window.location.href="http://verificentros.net/ecologia";
	...
	<table width="100%" height="50" border="0" cellpadding="0" cellspacing="0">
	  ...
	  <tr>
	   ...
	   <td background="eco_images/bannertop-bg.gif"><span class="whiteText17">ECOLOGIA</span></td>
		 <!--<td bgcolor="#FFFFFF" valign="top">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="whiteText17"><img src="eco_images/foldio-logo-inicio.jpg" height="48px"/></span></td>-->
	...
	if($Menu['tipo']>$_POST['tipousuario']){
		echo '<script>alert("No tiene acceso al menu");document.forma.cvemenu.value=1;atcr("eco_inicio.php","",0,0);</script>';
	}
	...
	<td width="6" valign="top" background="eco_images/collapse_side_bg.gif"><img src="eco_images/collapse_side_bg.gif" width="6" height="1" /></td>

	<td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">

	  <tr>

		<td width="30%" height="24" nowrap background="eco_images/optionHeader.gif"><b>:: '.$menuEncabezado.' ::</b></td>

		<td background="eco_images/optionHeader.gif"><div align="right">Bienvenido '.$SESSION['CallNomUsuario'].'</div></td>
		
		<td background="eco_images/optionHeader.gif"><div align="center" id="idreloj">'.fechaLocal().' '.horaLocal().'</div></td>

		<td width="15%" background="eco_images/optionHeader.gif" align="center" nowrap><a href="eco_logout.php">Cerrar Sesion</a></td>
...
function bottom() {
	...
	echo '
	  ...
	  <tr>
	    ...
	    <td colspan="3" valign="top" bgcolor="#33FFFF">&nbsp;</td>
...
function menuppal2($SESSION) {
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="3">
		<tr><td height="20" bgcolor="#33FFFF"><span class="style1">Menu</span></td></tr>';
		$rs=mysql_query("SELECT * FROM eco_menu WHERE tipo<='".$_POST['tipousuario']."' ORDER BY orden");
...
function menunavegacion() {
	...
	if ($eTotalPaginas>0) {
		...
		if ($primerRegistro>0) {
			...
			<td width="12" align="center" class="sanLR10"><a href="JavaScript:moverPagina(0);"><img src="eco_images/mover-primero.gif" width="10" height="12" border="0" align="absmiddle" title="Inicio"></a> </td>';

		} else {

			echo '

			<td width="12" align="center" class="sanLR10"><img src="eco_images/mover-primero-d.gif" width="10" height="12" border="0" align="absmiddle"></td>';
		...
		if ($eAnteriorPagina>=0) {
			...
			<td width="12" align="center" class="sanLR10"><a href="JavaScript:moverPagina('.$eAnteriorPagina.');"><img src="eco_images/mover-anterior.gif" width="7" height="12" border="0" align="absmiddle" title="Anterior"></a></td>';

		} else {

			echo '

			<td width="12" align="center" class="sanLR10"><img src="eco_images/mover-anterior-d.gif" width="7" height="12" border="0" align="absmiddle"></td>';
		...
		if ($eSiguientePagina<=$eTotalPaginas) {
			...
			<td width="12" align="center" class="sanLR10"><a href="JavaScript:moverPagina('.$eSiguientePagina.');"><img src="eco_images/mover-siguiente.gif" width="7" height="12" border="0" align="absmiddle" title="Siguiente"></a></td>';

		} else {

			echo '

			<td width="12" align="center" class="sanLR10"><img src="eco_images/mover-siguiente-d.gif" width="7" height="12" border="0" align="absmiddle"></td>';
		...
		if ($eNumeroPagina<$eTotalPaginas) {
			...
			<td width="12" align="center" class="sanLR10"> <a href="JavaScript:moverPagina('.$eTotalPaginas.');"><img src="eco_images/mover-ultimo.gif" width="10" height="12" border="0" align="absmiddle" title="Fin"></a></td>';

		} else {

			echo '

			<td width="12" align="center" class="sanLR10"><img src="eco_images/mover-ultimo-d.gif" width="10" height="12" border="0" align="absmiddle"></td>';
