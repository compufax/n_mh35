...
<body>
<p>&nbsp;</p>
<form id="forma" name="forma" method="POST" action="verificentros_df/inicio.php">
  <table width="530" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#F1F3F5" class="loginTable">
    <tr>
      <td width="30%" height="24" colspan="2" nowrap background="images/optionHeader.png">&nbsp;</td>
    </tr>
    <tr>
      <td width="50%"><div align="center">
        ...
        <table width="70%" border="0">
            ...
            <tr>
              <td class="bodyText"><div align="center">&iexcl; Sistema MH35 ! </div></td>
            </tr>
            <tr>
      ...
      <td width="50%"><div align="center">
          ...
          <table width="90%" border="0" class="loginInnerTable">
            <tr>
              <td colspan="5"><a target="_blank" href="http://www.gverificentros.com/facturacion/"></a>
			  </br><img src="images/login.gif" width="80" height="36" /></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
