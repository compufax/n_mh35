...
if($_POST['cmd']==101){
	...
	echo '<table>';
		...
		echo '<tr><td colspan="2"><h3>Ventas Hologramas</h1>
		...
		echo '<tr><td colspan="2"><h3>Creditos</h1>
		...
		echo '<tr><td colspan="2"><h3>Hologramas Pagados Anticipados</h1>
		...
		echo '<tr><td colspan="2"><h3>Pagos Anticipados</h1>
