...
if($_POST['cmd']==100){
	echo '<h1>Timbres Usados del '.$_POST['fecha_ini'].' al '.$_POST['fecha_fin'].'</h1>';
	...
	if($_POST['localidad']!='all'){
		$res1=mysql_query("SELECT a.* FROM plazas a INNER JOIN datosempresas b ON a.cve = b.plaza WHERE a.estatus!='I' AND a.cve IN (".$_POST['plaza'].") AND b.localidad_id = '".$_POST['localidad']."' ORDER BY b.localidad_id, a.lista, a.numero");
	}
	else{
		$res1=mysql_query("SELECT a.* FROM plazas a INNER JOIN datosempresas b ON a.cve = b.plaza WHERE a.estatus!='I' AND a.cve IN (".$_POST['plaza'].") ORDER BY b.localidad_id, a.lista, a.numero");
	}
