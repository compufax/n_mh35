...
if($_POST['cmd']==6){
	...
	foreach($_POST['checksf'] as $cveprefact){
		...
		if($row = mysql_fetch_array($res)){
			$res2 = mysql_query("SELECT serie,folio_inicial FROM foliosiniciales WHERE plaza='".$_POST['plazausuario']."' AND tipo=0 AND tipodocumento=1");
			$row2 = mysql_fetch_array($res2);
			$res1 = mysql_query("SELECT IFNULL(MAX(folio+1),1) FROM facturas WHERE plaza='".$_POST['plazausuario']."' AND serie='".$row2['serie']."'");
			$row1 = mysql_fetch_array($res1);
			if($row2['folio_inicial']<$row1[0]){
				$row2['folio_inicial'] = $row1[0];
			}
			$insert = "INSERT facturas SET plaza='".$_POST['plazausuario']."',serie='".$row2['serie']."',folio='".$row2['folio_inicial']."',fecha='".fechaLocal()."',fecha_creacion='".fechaLocal()."',hora='".horaLocal()."',obs='".$row['obs']."',
			...
			carta_porte='".$row['carta_porte']."',load_cliente='".$row['load']."',nombre_cliente='".$row['nombre_cliente']."',direccion_cliente='".$row['direccion_cliente']."',
			...
			engomado='".$row['engomado']."',banco='".$row['banco']."',cuenta_cheque='".$row['cuenta_cheque']."',tiene_descuento='".$row['tiene_descuento']."'".$datossucursal;
			...
			if(mysql_num_rows($res1) > 0){
				mysql_query("INSERT facturas SET plaza='".$_POST['plazausuario']."',fecha='".fechaLocal()."',fecha_creacion='".fechaLocal()."',hora='".horaLocal()."',obs='".$row['obs']."',
				cliente='".$row['cliente']."',tipo_pago='".$row['tipo_pago']."',forma_pago='".$row['forma_pago']."',usuario='".$_POST['cveusuario']."',baniva_retenido='".$row['baniva_retenido']."',banisr_retenido='".$row['banisr_retenido']."',
				...
				tipopago_cliente='".$row['tipopago_cliente']."',banco_cliente='".$row['banco_cliente']."',cuenta_cliente='".$row['cuenta_cliente']."',tipo_factura='".$row['tipo_factura']."',
				engomado='".$row['engomado']."',banco='".$row['banco']."',cuenta_cheque='".$row['cuenta_cheque']."',tiene_descuento='".$row['tiene_descuento']."'") or die(mysql_error());
			}
			else{
				mysql_query("INSERT facturas SET plaza='".$_POST['plazausuario']."',cve='".$row2['folio_inicial']."',fecha='".fechaLocal()."',fecha_creacion='".fechaLocal()."',hora='".horaLocal()."',obs='".$row['obs']."',
				cliente='".$row['cliente']."',tipo_pago='".$row['tipo_pago']."',forma_pago='".$row['forma_pago']."',usuario='".$_POST['cveusuario']."',baniva_retenido='".$row['baniva_retenido']."',banisr_retenido='".$row['banisr_retenido']."',
				carta_porte='".$row['carta_porte']."',load_cliente='".$_POST['load']."',nombre_cliente='".$row['nombre_cliente']."',direccion_cliente='".$row['direccion_cliente']."',
				tipopago_cliente='".$row['tipopago_cliente']."',banco_cliente='".$row['banco_cliente']."',cuenta_cliente='".$row['cuenta_cliente']."',tipo_factura='".$row['tipo_factura']."',
				engomado='".$row['engomado']."',banco='".$row['banco']."',cuenta_cheque='".$row['cuenta_cheque']."',tiene_descuento='".$row['tiene_descuento']."'") or die(mysql_error());
			...
			$documento=array();
			$fserie=$row2['serie'];
			$ffolio=$row2['folio_inicial'];
			//Generamos la Factura
			$documento['serie']=$row2['serie'];
			$documento['folio']=$row2['folio_inicial'];
			...
			while($row2 = mysql_fetch_array($res2))
			{
				...
				precio='".$row2['precio']."',descuento='".$row2['descuento']."',importe='".$row2['importe']."',iva='".$row2['iva']."',importe_iva='".$row2['importe_iva']."',unidad='".$row2['unidad']."',
...
if($_POST['cmd']==2){
	...
	venta='".$_POST['venta']."',tiene_descuento='".$_POST['tiene_descuento']."'") or die(mysql_error());
	$cvefact=mysql_insert_id();
