...
if($_POST['cmd']==100){
	...
	<th>Cortesia</th><th>Intentos RV</th><th>Intentos PA</th><th>F/Ingreso</th><th>Final</th><!--<th>Total Compra</th><th>Total Venta</th>--></tr>';
	$totales = array();
...
if($_POST['ajax']==1){
	...
	<th>Cortesia</th><th>Intentos</th><th>Reverificacion</th><!--<th>Intentos PA</th>--><th>S/Ingreso</th><th>Final</th><!--<th>Total Compra</th><th>Total Venta</th>--></tr>';
	$totales = array();
	$res = mysql_query("SELECT * FROM engomados WHERE entrega=1 ORDER BY nombre");
	while($row = mysql_fetch_array($res)){
		rowb();
