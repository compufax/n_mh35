...
if($_POST['ajax']==1){
	...
	if(mysql_num_rows($res)>0) 
	{
		...
		echo '<th>Folio</th><th>Fecha</th><th>Plaza</th><th>Motivo</th><th>Consignatario</th><th>Monto</th><th>Concepto</th><th>Usuario</th>';
		echo '</tr>';
		$t=0;
		while($row=mysql_fetch_array($res)) {
			rowb();
...
if ($_POST['cmd']==1) {
	...
	echo '<script>
			function validar(){
				...
				else if(document.forma.consignatario.value=="0"){
					$("#panel").hide();
