...
/*** EDICION  **************************************************/
	...
	if ($_POST['cmd']==1) {
		...
		echo '<tr><th align="left">No Parte</th><td><input type="text" name="noparte" id="noparte" class="textField" size="50" value="'.$row['noparte'].'"></td></tr>';
		echo '<tr><th align="left">No Serie</th><td><input type="text" name="noserie" id="noserie" class="textField" size="50" value="'.$row['noserie'].'"></td></tr>';
		echo '<tr><th align="left">Descripcio&oacute;n</th><td><input type="text" name="nombre" id="nombre" class="textField" size="100" value="'.$row['nombre'].'"></td></tr>';
		echo '</table>';
