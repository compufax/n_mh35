...
<title>:: VEREFICENTROS MANTENIMIENTO DE LINEAS ::</title>
<link rel="stylesheet" type="text/css" href="css/style.css" />
<script>
	if(top.window.location.href!="http://verificentrosgp1.net/mantenimiento/" && top.window.location.href!="http://manon.verificentrosdf.net/mantenimiento/" && top.window.location.href!="http://hqtechnology.com.mx/")
...
<body>
<p>&nbsp;</p>
<form id="forma" name="forma" method="POST" action="mantenimiento_reporte_lineas.php">
    ...
    <tr>
      <td width="50%"><div align="center">
        ...
        <table width="70%" border="0">
            <tr>
              <td><div align="center"><img src="images/logingif.gif?<?php echo date("Y-m-d");?>" width="80" height="69" /></div></td>
            </tr>
            <tr>
              <td class="bodyText"><div align="center">&iexcl; VEREFICENTROS MANTENIMIENTO DE LINEAS ! </div></td>
            </tr>
            <tr>
