...
if($_POST['cmd']==100){
	echo '<h2>Reporte de Certificados '.$_POST['fecha_ini'].' al '.$_POST['fecha_fin'];
...
top($_SESSION);
	if($_POST['cmd']==2){
		...
		echo '<h2>Reporte de Certificados por tipo placa '.$array_tipo_placa[$datos[0]].' de '.$array_engomado[$datos[1]].' '.$tipo2.' del dia '.$_POST['fecha_ini'].' al '.$_POST['fecha_fin'].'</h2>';
