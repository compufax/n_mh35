...
$rsUsuario=mysql_query("SELECT a.cve,a.numero,a.nombre FROM plazas a inner join datosempresas b on a.cve = b.plaza where a.estatus!='I' and b.localidad_id = 2 ORDER BY a.numero");
while($Usuario=mysql_fetch_array($rsUsuario)){
