...
if($_POST['ajax']==1){
	...
	$html.= '<tr bgcolor="#E9F2F8">
			...
			$html.='<th rowspan="2">Total</th></tr><tr bgcolor="#E9F2F8">';
			 $fecha=$_POST['fecha_ini'];
			while($fecha<=$_POST['fecha_fin']){
			//	$html.='<th colspan="13">'.$fecha.'</th>';
			  //  $html.='</tr>';
...
top($_SESSION);
	...
	if ($_POST['cmd']<1) {
		...
		echo '<tr>
				...
				<!--<td><a href="#" onclick="atcr(\'#ventas_x_hora.php\',\'_blank\',100,0);"><img src="images/b_print.png" border="0">&nbsp;&nbsp;Imprimir</a>&nbsp;&nbsp;</td>
				<td><a href="#" onclick="atcr(\'#ventas_x_hora.php\',\'_blank\',101,0);"><img src="images/b_print.png" border="0">&nbsp;&nbsp;Imprimir</a>&nbsp;&nbsp;</td>
				<td><a href="#" onclick="atcr(\'#ventas_x_hora.php\',\'_blank\',102,0);"><img src="images/b_print.png" border="0">&nbsp;&nbsp;Imprimir</a>&nbsp;&nbsp;</td>-->';
		echo '</tr>';
		echo '</table>';
		echo '<table>';
...
<Script language="javascript">
	function buscarRegistros(){
		...
		if (objeto.readyState != 0) {
			...
			objeto.open("POST","#ventas_x_hora.php",true);
