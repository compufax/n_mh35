...
if($_POST['cmd']==100){
	echo '<h2>Reporte de Clasificacion de Vehiculo '.$_POST['fecha_ini'].' al '.$_POST['fecha_fin'];
...
top($_SESSION);
	...
	if($_POST['cmd']==1){
		...
		echo '<h2>Reporte de Clasificacion de vehiculo de '.$array_engomado[$datos[1]].' tipo '.$array_tipo_placa[$datos[2]].' del dia '.$datos[0].'</h2>';
