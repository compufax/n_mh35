...
header("Expires: 0");
	...
	$c=13;
	$html.= '<tr bgclor="#E9F2F8"><th>Centro</th>';
...
//		}
	...
	$c=4;
	$html.= '<tr>';
	$html.= '<td bgcoor="#E9F2F8" align="right" colspan="1">&nbsp;Total</td>';
...
if($_POST['cmd']==101){
	...
	$c=13;
	echo '<tr bgcolo="#E9F2F8"><th>Centro</th>';
...
//		$roww=mysql_fetch_array($res);
	...
	$c=4;
	echo '<tr>';
	echo '<td bgcolo="#E9F2F8" align="right" colspan="1">&nbsp;Total</td>';
	foreach($sumacargo as $k=>$v){
		if($k>2) $decimal=2;
		else $decimal=0;
...
if($_POST['ajax']==1){
	...
	$c=13;
	$html.= '<tr bgcolor="#E9F2F8"><th>Centro</th>';
	$html.= '<th>Aforo</th><th>Rechazo</th><th>Total</th><th>Importe</th><th>Pago Ant</th><th>R.Credito</th><th>Venta Total</th></tr>'; 
	$sumacargo=array(0,0,0,0);
	$x=0;
	$array_importes_plaza=array();
...
//		$roww=mysql_fetch_array($res);
	...
	foreach($array_plazas as $k=>$v){
		...
		$html.= '<td align="right">'.number_format($array_importes_plaza[$k][4],2).'</td>';
		$html.= '<td align="right">'.number_format($array_importes_plaza[$k][5],2).'</td>';
		$html.= '<td align="right">'.number_format(($array_importes_plaza[$k][3]+$array_importes_plaza[$k][4]+$array_importes_plaza[$k][5]),2).'</td>';
		$html.= '</tr>';
		$x++;
	}
	/*echo '<tr><td colspan="6">&nbsp;</td></tr>';
	...
	$c=4;
	$html.= '<tr>';
	$html.= '<td bgcolor="#E9F2F8" align="right" colspan="1">&nbsp;Total</td>';
	foreach($sumacargo as $k=>$v){
		if($k>2) $decimal=2;
		else $decimal=0;
...
top($_SESSION);
	...
	if ($_POST['cmd']<1) {
		...
		echo '<tr>
				...
				<td><a href="#" onclick="atcr(\'informe_ventas2.php\',\'_blank\',100,0);"><img src="images/b_print.png" border="0">&nbsp;&nbsp;Imprimir</a>&nbsp;&nbsp;</td>
				<td><a href="#" onclick="atcr(\'informe_ventas2.php\',\'_blank\',101,0);"><img src="images/b_print.png" border="0">&nbsp;&nbsp;Imprimir</a>&nbsp;&nbsp;</td>
				<td><a href="#" onclick="atcr(\'informe_ventas2.php\',\'_blank\',102,0);"><img src="images/b_print.png" border="0">&nbsp;&nbsp;Imprimir</a>&nbsp;&nbsp;</td>';
		echo '</tr>';
		echo '</table>';
		echo '<table>';
...
<Script language="javascript">
	function buscarRegistros(){
		...
		if (objeto.readyState != 0) {
			...
			objeto.open("POST","informe_ventas2.php",true);
