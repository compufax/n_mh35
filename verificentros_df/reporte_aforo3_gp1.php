...
*/
	...
	rowb();
	echo '<td>Ventas sin pago sin Certificado</td><td align="right"><a href="#" onClick="atcr(\'reporte_aforo3.php\',\'\',3,2)">'.number_format($row['intento']+$row['cortesia'],0).'</a></td><td align="right">'.number_format(0,2).'</td></tr>';
...
top($_SESSION);
	...
	if($_POST['cmd']==1){
		...
		if($_POST['reg']==2){
			...
			echo '<table width="100%"><tr bgcolor="#E9F2F8"><th>Tipo Cliente</th><th>Cantidad</th></tr>';
			$t=0;
