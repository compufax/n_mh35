...
if($_POST['ajax']==1) {
		...
		$select.=" AND fecha_compra BETWEEN '".$_POST['fecha_ini']."' AND '".$_POST['fecha_fin']."'";
		...
		if(mysql_num_rows($res)>0) 
		{
			...
			echo '<tr bgcolor="#E9F2F8"><th>&nbsp;</th><th>Consecutivo</th><th>Folio Compra</th><th>Fecha Compra</th><th>Fecha</th><th>Tipo de Certificado</th><th>Folio Inicial</th><th>Folio Final</th><th>Cantidad</th><th>Usuario</th>';
			echo '</tr>';
			$t=0;
			while($row=mysql_fetch_array($res)) {
				rowb();
...
if ($_POST['cmd']==2) {
		...
		if(mysql_num_rows($res)==0){
			...
			$insert = " INSERT compra_certificados 
							SET 
							folio='".$_POST['folio']."',fecha_compra='".$_POST['fecha_compra']."',
